 ...
 */
@customElement('brawlit-re-yellow')
export class BrawLitReYellow extends LitElement {
  ...
  render() {
    return html`
      <div class="brawl-btn-cont" style="
        max-width: ${(this.fontsize*3)*2}px;
  ...
  static styles = css`
    ...
    .brawl-btn {
      ...
      filter: drop-shadow( 0 2.5px 0 rgb(0,0,0,0.4) );
    }
    .brawl-btn div{
      width: 100%;
      z-index: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'brawlit-re-yellow': BrawLitReYellow
  }
}
